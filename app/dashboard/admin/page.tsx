...
async function getSchoolStats() {
  ...
  const [profilesResult, gradesResult, subjectsResult, classesResult, schoolResult] = await Promise.all([
              ...
              <div className="grid gap-2">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Add teachers, students, and parents</p>
                  </div>
                </a>
                <a
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Create and configure classes</p>
                  </div>
                </a>
                <a
